...
**Рекомендация владельцу** (решение — по критерию остановки 1 — его):
...
Решение по D1 — за владельцем. До него из бэклога имеет смысл только
[B-23](../backlog/B-23-dispatcher-spin-hypothesis.md): три конфигурации ядер за пять минут,
и вердикт по CPU станет чище. Остальные задачи второй фазы
([B-18](../backlog/B-18-rq6-inline-bloat-diagnostic.md)…[B-21](../backlog/B-21-rq4-lazy-logging-lint.md))
разблокированы формально и ждут решения содержательно.
